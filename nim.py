...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        `state`, return 0.
        """
        # If no actions are available in the state, we will return 0
        best_reward = 0

        # Loop through the available action searching for the one
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # If epsilon was set True with the chance equal to the value of
        # epsilon we will chose a random available move
        if epsilon and random.random() <= self.epsilon:

            return random.sample(available_actions, 1)[0]
        
        # If epsilon was set False, the function will return the best
        # possible action available in that state
